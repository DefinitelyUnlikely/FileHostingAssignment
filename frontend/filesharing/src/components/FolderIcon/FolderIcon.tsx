...
export function FolderIcon() {
    ...
    return (
        <div className="folder-icon">
            ...
            10.4083 5 10.6385 5.05526C10.8425 5.10425 11.0376 5.18506 11.2166 
            ...
            7H17.8C18.9201 7 19.4802 7 19.908 7.21799C20.2843 7.40973 20.5903 
            7.71569 20.782 8.09202C21 8.51984 21 9.0799 21 10.2V15.8C21 16.9201 
            21 17.4802 20.782 17.908C20.5903 18.2843 20.2843 18.5903 19.908 
